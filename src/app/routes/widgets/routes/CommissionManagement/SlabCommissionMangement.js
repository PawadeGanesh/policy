...
const SlabCommissionManagement = ({
  ruleSlabs,
  userTypeData,
  ...
  const getUserTypeName = (userTypeId) => {
    console.log("userTypeId-id", userTypeId);
      ...
      <div className="my-5">
        <fieldset>
          <legend class="fieldLegend">
            <IntlMessages id="CommissionManagement.Add.AddSlabBreakUp" />
          </legend>
          <div>
            {(ruleSlabs || []).map((x, i) => {
              return (
                              ...
                              <div className="row ml-2 pl-3">
                                <div className="col-lg-3">
                                  <InputAutocomplete
                                    ...
                                    value={getUserTypeName(n.userType) || ""}
                                    fullWidth
                                    renderInput={(params) => (
                                      <TextField
                                        {...params}
                          ...
                          <div className="col-lg-1">
                            ...
                            {x.slabBreakup.length !== 1 && (
                              <RemoveCircleOutlineIcon
                                ...
                                onClick={() => handleRemoveSubSlab(i, j)}
                              />
                            )}
                          </div>
                        </>
...
export default SlabCommissionManagement;
