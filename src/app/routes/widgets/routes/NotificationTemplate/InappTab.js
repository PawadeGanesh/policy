...
const InappTab = ({
  ...
  inappNotifyLang,
  inappExp,
  handleInappInputChange,
  isInappNotifyLangChange,
  isInappExpChange,
  handleInappChange,
  handleInappEditorChange,
  formDialogOpen,
    ...
    <>
      ...
      >
          ...
          <div className="row">
            ...
            <div className="col-lg-12 mt-3">
              <CKEditor
                content={content || ""}
                events={{
                  change: handleInappEditorChange,
                }}
              />
            </div>
          </div>
        ...
        <DialogActions>
          ...
          <InputSubmitButton
            onClick={(e) => handleAddFormSubmit(e, "inapp")}
      ...
      <div className="row">
        <div className="col-lg-4">
          <InputField
            ...
            id="notifyLanguage"
            label={
              <IntlMessages id="notificationtempalet.master.modal.edit.felid.inapp.NotifyLanguage" />
            }
            name="notifyLanguage"
            onChange={(e) => handleInappInputChange(e)}
            value={inappNotifyLang || ""}
            error={isInappNotifyLangChange}
            helperText={
              isInappNotifyLangChange ? "NotifyLanguage is Required" : null
            }
            fullWidth
          />
        </div>
        <div className="col-lg-4">
          <InputField
            ...
            id="toExpression"
            label={
              <IntlMessages id="notificationtempalet.master.modal.edit.felid.inapp.ToExpression" />
            }
            name="toExpression"
            onChange={(e) => handleInappInputChange(e)}
            value={inappExp || ""}
            error={isInappExpChange}
            helperText={isInappExpChange ? "Expression is Required" : null}
            fullWidth
          />
        </div>
      </div>
          ...
          <div className="flex-auto p-3">
            ...
            >
              <Table>
                ...
                <TableBody>
                  {console.log("inapp-checking", inappData)}
                  {(inappData || [])
                            ...
                            <TableCell padding="none">
                              ...
                              >
                                <IconButton
                                  id={n.id}
                                  onClick={(e) =>
                                    onTableEditButtonClick(e, n.id, "inapp")
                                  }
                                >
