...
const PushTab = ({
  ...
  pushNotifyLang,
  pushExp,
  handlePushInputChange,
  isPushNotifyLangChange,
  isPushExpChange,
  handlePushChange,
  handlePushEditorChange,
  formDialogOpen,
    ...
    <>
      ...
      >
        ...
        <DialogActions>
          ...
          <InputSubmitButton
            onClick={(e) => handleAddFormSubmit(e, "push")}
      ...
      >
        ...
        <DialogActions>
          ...
          <InputSubmitButton
            onClick={(e) => handleEditFormSubmit(e, "push")}
            disabled={!isEditContentDetailDisbaled}
          />
        </DialogActions>
      </Dialog>
      <div className="row">
        <div className="col-lg-4">
          <InputField
            ...
            name="notifyLanguage"
            onChange={(e) => handlePushInputChange(e)}
            value={pushNotifyLang || ""}
            error={isPushNotifyLangChange}
            helperText={
              isPushNotifyLangChange ? "NotifyLanguage is Required" : null
            }
            fullWidth
          />
        </div>
        <div className="col-lg-4">
          <InputField
            ...
            onChange={(e) => handlePushInputChange(e)}
            value={pushExp || ""}
            error={isPushExpChange}
            helperText={isPushExpChange ? "Expression is Required" : null}
            fullWidth
          />
        </div>
      </div>
          ...
          <div className="flex-auto p-3">
            ...
            >
              <Table>
                ...
                <TableBody>
                  {console.log("push-checking", pushData)}
                  {(pushData || [])
