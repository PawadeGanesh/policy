...
function INAPP_TAB_FixedToExpression(props) {
  const {
    key,
    id,
    name,
  ...
  useEffect(() => {
    localforage
      .setItem("INAPP_TAB_FixedToExpression", {
        toExpression: state.validation.toExpression,
        name: "toExpression",
      })
      .then(function() {
        return localforage.getItem("INAPP_TAB_FixedToExpression");
      })
      .then(function(value) {
        // we got our value
        //console.log("INAPP_TAB_FixedToExpression Data stored", value);
      })
      .catch(function(err) {
        // we got an error
...
INAPP_TAB_FixedToExpression.propTypes = {};

export default INAPP_TAB_FixedToExpression;
