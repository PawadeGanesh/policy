...
function EMAIL_TAB_FixedNotifyLanguage(props) {
  const {
    key,
    id,
    name,
  ...
  useEffect(() => {
    localforage
      .setItem("EMAIL_TAB_FixedNotifyLanguage", {
        notifyLanguage: state.validation.notifyLanguage,
        name: "notifyLanguage",
      })
      .then(function() {
        return localforage.getItem("EMAIL_TAB_FixedNotifyLanguage");
      })
      .then(function(value) {
        // we got our value
        //console.log("EMAIL_TAB_FixedNotifyLanguage Data stored", value);
      })
      .catch(function(err) {
        // we got an error
...
EMAIL_TAB_FixedNotifyLanguage.propTypes = {};

export default EMAIL_TAB_FixedNotifyLanguage;
