...
function INAPP_TAB_FixedNotifyLanguage(props) {
  const {
    key,
    id,
    name,
  ...
  useEffect(() => {
    localforage
      .setItem("INAPP_TAB_FixedNotifyLanguage", {
        notifyLanguage: state.validation.notifyLanguage,
        name: "notifyLanguage",
      })
      .then(function() {
        return localforage.getItem("INAPP_TAB_FixedNotifyLanguage");
      })
      .then(function(value) {
        // we got our value
        //console.log("INAPP_TAB_FixedNotifyLanguage Data stored", value);
      })
      .catch(function(err) {
        // we got an error
...
INAPP_TAB_FixedNotifyLanguage.propTypes = {};

export default INAPP_TAB_FixedNotifyLanguage;
