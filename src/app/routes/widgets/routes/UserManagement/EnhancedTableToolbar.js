            ...
            <form className="row" autoComplete="off">
              <div className="col-lg-3 col-sm-6 col-12 mb-3">
                <InputField
                  ...
                  name="username"
                  label={
                    <IntlMessages id="UserManagement.master.advancedsearch.username" />
                  }
                  fullWidth
                />
              </div>
              <div className="col-lg-3 col-sm-6 col-12 mb-3">
                <InputField
                  ...
                  fullWidth
                  label={
                    <IntlMessages id="UserManagement.master.advancedsearch.firstname" />
                  }
                />
              </div>
              ...
              <div className="col-lg-3 col-sm-6 col-12 mb-3">
                <InputField
                  ...
                  fullWidth
                  label={
                    <IntlMessages id="UserManagement.master.advancedsearch.lastname" />
                  }
                />
              </div>
              ...
              <div className="col-lg-3 col-sm-6 col-12 mb-3">
                <InputField
                  ...
                  fullWidth
                  label={
                    <IntlMessages id="UserManagement.master.advancedsearch.emailid" />
                  }
                />
              </div>
