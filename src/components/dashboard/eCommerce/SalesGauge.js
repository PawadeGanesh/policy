...
const SalesGauge = ({ newRevenuePercentage, renewalRevenuePercentage }) => {
  useEffect(() => {
    ...
    chart.data = [
      {
        category: "Renewal Revenue",
        value: renewalRevenuePercentage,
        full: 100,
      },
      {
        category: "New Revenue",
        value: newRevenuePercentage,
        full: 100,
      },
      {
  ...
  }, [newRevenuePercentage, renewalRevenuePercentage]);
